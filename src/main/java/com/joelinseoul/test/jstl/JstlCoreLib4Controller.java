...
@Controller
public class JstlCoreLib4Controller {

	@GetMapping("/jstl/fnLib")
	public String fnLibController(Model model) {
		
		List<ThreeKingdomsMember> members = new ArrayList<>();
		
		ThreeKingdomsMember member = new ThreeKingdomsMember();
		member.setName("유비");
		...
		member = new ThreeKingdomsMember();
		member.setName("관우");
		member.setPhoneNumber("010-1234-5678");
		...
		model.addAttribute("membersMd",members);
